...
public final class MyDataInfo {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using top.tomxwd.netty.codec2.MyDataInfo.MyMessage.newBuilder()
      private Builder() {
  ...
  public interface StudentOrBuilder extends
    ...
    /**
     * <pre>
     * Student类中有一个属性名字为id，类型为int32（protobuf类型）1不代表值，表示属性的序号
     * </pre>
     *
  ...
  /**
   * <pre>
   * 会在外部类生成一个内部类Student，他是真正的发送POJO对象
   * </pre>
   *
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using top.tomxwd.netty.codec2.MyDataInfo.Student.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      // Construct using top.tomxwd.netty.codec2.MyDataInfo.Worker.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
